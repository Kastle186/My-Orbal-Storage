...
\begin{itemize}[leftmargin=0.15in, label={}]
  ...
  \resumeCompanyHeading
    ...
    \resumePositionHeading
      ...
      \begin{itemize}
        \resumeItem{Developed a seamless transition system for Microsoft Office updates and upgrades, efficiently ensuring compliance and keeping Amazon environments secure.}
        \resumeItem{Built a new job to monitor internal system drift in Amazon environments, and adjust accordingly, ensuring consistency and accuracy at all times.}
        \resumeItem{Designed and implemented a configurable system for finding the official releases of specific software, streamlining processes in the environments. Additionally, engineered an interface system to facilitate testing the system efficiently.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
    ...
    \resumeSkillList
      {Technologies}{Git, Docker, Linux, AWS, Software Design, Software Infrastructure, .NET, Node.js, HTML/CSS, LaTeX, Emacs, Vim, Oracle, Discord API, Jetbrains, Visual Studio, LLDB, GIMP}
    \resumeSkillList
