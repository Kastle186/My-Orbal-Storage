...
(defvar my-elisp-keywords '(("\\_<add-hook\\_>"             . font-lock-builtin-face)
                            ...
                            ("\\_<cons\\_>"                 . font-lock-builtin-face)
                            ...
                            ("\\_<nreverse\\_>"             . font-lock-builtin-face)
...
(defvar my-java-keywords '(("\\_<charAt\\_>"    . font-lock-builtin-face)
                           ...
                           ("\\_<\\(Arrays\\).\\(sort\\)"       2 font-lock-builtin-face)
                           ("\\_<\\(Integer\\).\\(MAX_VALUE\\)" 2 font-lock-constant-face)
                           ("\\_<\\(Integer\\).\\(MIN_VALUE\\)" 2 font-lock-constant-face)
...
(defvar my-rust-keywords '(("\\_<chars\\_>"     . font-lock-builtin-face)
                           ("\\_<clone\\_>"     . font-lock-builtin-face)
                           ("\\_<collect\\_>"   . font-lock-keyword-face)
                           ("\\_<enumerate\\_>" . font-lock-builtin-face)
                           ("\\_<floor\\_>"     . font-lock-builtin-face)
                           ...
                           ("\\_<pop\\_>"       . font-lock-builtin-face)
                           ("\\_<pow\\_>"       . font-lock-builtin-face)
                           ("\\_<push\\_>"      . font-lock-builtin-face)
                           ("\\_<remove\\_>"    . font-lock-builtin-face)
                           ("\\_<rev\\_>"       . font-lock-builtin-face)
                           ("\\_<sum\\_>"       . font-lock-builtin-face)
                           ("\\_<to_string\\_>" . font-lock-builtin-face)
