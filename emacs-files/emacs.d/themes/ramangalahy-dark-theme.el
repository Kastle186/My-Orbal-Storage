;; ramangalahy-dark-theme.el

;; This is a small adaptation of the color theme 'ramangalahy' from the suite
;; named 'color-themes-modern' to have a dark mode version.

(deftheme ramangalahy-dark
  "ramangalahy dark theme")

(custom-theme-set-faces
 'ramangalahy-dark

 '(default ((t (:background "black" :foreground "lightgrey"))))
 ...
 '(font-lock-comment-face ((t (:bold t :foreground "#c061cb"))))
 '(font-lock-doc-string-face ((t (:bold t :foreground "slateblue"))))
 '(font-lock-emphasized-face ((t (:bold t :background "lightyellow2"))))
 '(font-lock-function-name-face ((t (:bold t :foreground "#5478e4"))))
 '(font-lock-keyword-face ((t (:bold t :foreground "#c71585"))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "#c71585"))))
...
(provide-theme 'ramangalahy-dark)

;;; ramangalahy-dark-theme.el ends here
