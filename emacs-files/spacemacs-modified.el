...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#14100a" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
...
;;;;; basics
     ...
     `(default ((,class (:background ,bg3 :foreground ,base))))
...
;;;;; calfw
     ...
     `(cfw:face-toolbar             ((,class (:foreground ,base :background ,bg3))))
...
;;;;; centaur-tabs
     `(centaur-tabs-default ((,class (:background ,bg3 :foreground ,bg1))))
...
;;;;; dired
     `(dired-directory ((,class (:foreground ,keyword :background ,bg3 :inherit bold))))
     ...
     `(dired-symlink ((,class (:foreground ,cyan :background ,bg3 :inherit bold))))
...
;;;;; enh-ruby
     `(enh-ruby-op-face ((,class (:background ,bg3 :foreground ,base))))
...
;;;;; helm
     ...
     `(helm-buffer-directory ((,class (:foreground ,base :background ,bg3))))
     `(helm-buffer-file ((,class (:foreground ,base :background ,bg3))))
     `(helm-buffer-not-saved ((,class (:foreground ,comp :background ,bg3))))
     `(helm-buffer-process ((,class (:foreground ,keyword :background ,bg3))))
     `(helm-buffer-saved-out ((,class (:foreground ,base :background ,bg3))))
     `(helm-buffer-size ((,class (:foreground ,base :background ,bg3))))
     `(helm-candidate-number ((,class (:background ,bg3 :foreground ,keyword :inherit bold))))
     `(helm-ff-directory ((,class (:foreground ,keyword :background ,bg3 :inherit bold))))
     `(helm-ff-dotted-directory ((,class (:foreground ,keyword :background ,bg3 :inherit bold))))
     `(helm-ff-dotted-symlink-directory ((,class (:foreground ,cyan :background ,bg3 :inherit bold))))
     `(helm-ff-executable ((,class (:foreground ,suc :background ,bg3 :weight normal))))
     `(helm-ff-file ((,class (:foreground ,base :background ,bg3 :weight normal))))
     `(helm-ff-invalid-symlink ((,class (:foreground ,red :background ,bg3 :inherit bold))))
     `(helm-ff-prefix ((,class (:foreground ,bg1 :background ,keyword :weight normal))))
     `(helm-ff-symlink ((,class (:foreground ,cyan :background ,bg3 :inherit bold))))
     `(helm-grep-cmd-line ((,class (:foreground ,base :background ,bg3))))
     `(helm-grep-file ((,class (:foreground ,base :background ,bg3))))
     `(helm-grep-finish ((,class (:foreground ,base :background ,bg3))))
     `(helm-grep-lineno ((,class (:foreground ,type :background ,bg3 :inherit bold))))
     `(helm-grep-match ((,class (:foreground unspecified :background unspecified :inherit helm-match))))
     `(helm-header ((,class (:foreground ,base :background ,bg3 :underline nil :box nil))))
     ...
     `(helm-moccur-buffer ((,class (:foreground ,var :background ,bg3))))
     `(helm-selection ((,class (:background ,highlight))))
     `(helm-selection-line ((,class (:background ,bg2))))
     `(helm-separator ((,class (:foreground ,comp :background ,bg3))))
     `(helm-source-header ((,class (:background ,comp :foreground ,bg1 :inherit bold))))
     `(helm-time-zone-current ((,class (:foreground ,keyword :background ,bg3))))
     `(helm-time-zone-home ((,class (:foreground ,comp :background ,bg3))))
...
;;;;; magit
     ...
     `(magit-section-title ((,class (:background ,bg3 :foreground ,keyword :inherit bold))))
...
;;;;; mode-line
     ...
     `(mode-line-inactive  ((,class (:foreground ,base :background ,bg3  :box (:color ,border :line-width 1)))))
...
;;;;; tabbar
     ...
     `(tabbar-default ((,class (:background ,bg3 :foreground ,head1 :height 0.9))))
     ...
     `(tabbar-unselected ((,class (:inherit tabbar-default :background ,bg3 :slant italic :weight light))))
     `(tabbar-unselected-modified ((,class (:inherit tabbar-unselected :background ,bg3 :foreground ,red))))

;;;;; term
     `(term ((,class (:foreground ,base :background ,bg3))))
...
;;;;; vterm
     `(vterm-color-default ((,class (:foreground ,base :background ,bg3))))
...
;;;;; tab-bar-mode
     `(tab-bar ((,class (:foreground ,base :background ,bg3))))
     `(tab-bar-tab ((,class (:foreground ,base :background ,bg3 :weight bold))))
     `(tab-bar-tab-inactive ((,class (:foreground ,base-dim :background ,bg2 :weight light))))

;;;;; tab-line-mode
     `(tab-line ((,class (:foreground ,base :background ,bg3))))
     `(tab-line-tab-current ((,class (:foreground ,base :background ,bg3 :weight bold))))
...
;;;;; pdf-tools
    `(pdf-view-midnight-colors '(,base . ,bg3)))
    ))
